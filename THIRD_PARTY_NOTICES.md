...
Hermes Session Lens uses public APIs and behavior patterns from MIT-licensed open-source projects. The initial implementation was written independently and does not vendor upstream source files.

| Project | Copyright | License | Use here |
| --- | --- | --- | --- |
...
| CodexBar | Copyright (c) 2026 Peter Steinberger | MIT | Kimi Code Plan response-shape and rolling-window behavior reference |
