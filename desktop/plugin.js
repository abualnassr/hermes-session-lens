    ...
    children: [
      ...
      open
        ? jsxs('div', {
            ...
            style: { background: 'var(--popover, var(--background, Canvas))', border, borderRadius: '6px', boxShadow: '0 8px 24px rgba(0,0,0,0.28)', minWidth: '14rem', padding: '0.35rem', position: 'absolute', right: 0, top: 'calc(100% + 0.35rem)', zIndex: 30 },
            children: [
              jsx('button', {
